// src/App.jsx - ORBIT Themed (Visible Background)
...
function App() {
  ...
  if (showWelcome) {
    return (
      <div 
        className={`fixed inset-0 bg-gradient-to-br from-black via-[#0a0a0a] to-[#050505] flex items-center justify-center z-50 transition-opacity duration-800 ${fadeOut ? 'opacity-0' : 'opacity-100'}`}
        onClick={handleStart}
      >
        ...
        <div className="relative z-10 text-center cursor-pointer max-w-4xl mx-auto px-6">
  ...
  // Orbit Themed Homepage - Visible Background
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-x-hidden">
      
      {/* Starfield Background - Brighter */}
      ...
      {/* Radial gradient overlay - lighter for better visibility */}
      <div className="fixed inset-0 pointer-events-none">
      ...
      {/* Navbar */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-black/70 backdrop-blur-xl border-b border-white/15`}>
